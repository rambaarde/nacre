...
<!-- Only rules you would otherwise repeat next week. Project-specific rules go
     in the project. -->
...
<!-- # Not Here
     Architecture, API docs, onboarding guides. repertory is a log, not a wiki.
     ...
     project on a different stack never loads it. -->
