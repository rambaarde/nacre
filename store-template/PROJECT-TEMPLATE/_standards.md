...
<!-- Loaded with this project's brief, and only this project's. Stack-specific
     rules belong here; rules that hold everywhere belong in the company file. -->
...
* **Tests:** [What runs, and what must pass before merge]
